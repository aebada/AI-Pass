...
export async function checkForUpdatesInteractive(): Promise<void> {
  if (!app.isPackaged) {
    await dialog.showMessageBox({
      ...
      detail: 'Run a release build (`pnpm dist`) to test electron-updater against https://aipass.space/downloads/releases/.',
    });
    return;
  }
...
function notifyWindows(payload: Record<string, unknown>): void {
