...
const BUILTIN_MENTIONS: MentionOption[] = [
  { id: 'codebase', label: 'codebase', insert: '@codebase', icon: 'search', description: 'Search entire project' },
  { id: 'docs', label: 'docs', insert: '@docs', icon: 'book-open', description: 'Documentation context' },
  { id: 'folder', label: 'folder', insert: '@folder', icon: 'folder', description: 'Current folder' },
];
      ...
      {showMentions && filtered.length > 0 && (
        <div className={styles.mentionMenu} role="listbox">
          {filtered.slice(0, 12).map((option, i) => (
            ...
            >
              <span className={styles.mentionIcon}><ModuleIcon name={option.icon} size={16} /></span>
