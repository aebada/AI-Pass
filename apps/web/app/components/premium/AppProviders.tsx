...
interface AppContextValue {
  ...
  /** False until Laravel/PHP auth bridge finishes hydrating the session. */
...
export function AppProviders({ children }: { children: ReactNode }) {
  ...
  const [authResolved, setAuthResolvedState] = useState(!useServerAuth);
  ...
  const setAuthResolved = useCallback((resolved: boolean) => {
    setAuthResolvedState(resolved);
  }, []);
