...
export function ModuleScaffold({
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto', color: workspaceTokens.colors.text }}>
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: 16, marginBottom: 24 }}>
        {icon && <ModuleIcon name={icon} size={40} />}
        <div style={{ flex: 1 }}>
      ...
      {features.length > 0 && (
        ...
        >
          {features.map((f) => (
            <Card key={f} padding="md" variant="elevated">
