    ...
    <ComplianceShell>
      ...
      <div className={styles.card} style={{ marginTop: 16 }}>
        ...
        <table className={styles.table}>
          ...
          <tbody>
            <tr><td>Compliance AI core</td><td>—</td><td><ModuleIcon name="check" size={14} /></td><td><ModuleIcon name="check" size={14} /></td><td><ModuleIcon name="check" size={14} /></td></tr>
            <tr><td>Trust Center publish</td><td>—</td><td>—</td><td><ModuleIcon name="check" size={14} /></td><td><ModuleIcon name="check" size={14} /></td></tr>
            <tr><td>AI Copilot</td><td>—</td><td>—</td><td><ModuleIcon name="check" size={14} /></td><td><ModuleIcon name="check" size={14} /></td></tr>
            <tr><td>Audit evidence packages</td><td>—</td><td>—</td><td>—</td><td><ModuleIcon name="check" size={14} /></td></tr>
          </tbody>
        </table>
      </div>
      <div className={styles.card} style={{ marginTop: 16 }}>
