...
export default function ApprovalsPage() {
  ...
  return (
    <WorkspaceLayoutClient title="Approvals" subtitle="Human-in-the-loop review queue, escalation, and exception approvals">
      <ModuleScaffold title="Approval Queue" description="Review pending approvals, escalations, and policy exceptions." moduleId="governance" icon="landmark" status="done">
        <GovernanceShell>
          {approvals.map((a) => (
