...
export default function InventoryPage() {
  ...
  return (
    <WorkspaceLayoutClient title="AI Inventory" subtitle="Registered AI systems, agents, models, and workflows">
      <ModuleScaffold title="AI Inventory" description="Central registry of all AI systems with ownership, risk, and compliance status." moduleId="governance" icon="landmark" status="done">
        <GovernanceShell>
