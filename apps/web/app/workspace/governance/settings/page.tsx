...
export default function GovernanceSettingsPage() {
  return (
    <WorkspaceLayoutClient title="Governance Settings" subtitle="Lifecycle configuration, administration, and integrations">
      <ModuleScaffold title="Settings & Administration" description="Configure governance lifecycle, integrations, and org-wide policy automation." moduleId="governance" icon="landmark" status="done">
        <GovernanceShell>
