...
export default function RisksPage() {
  ...
  return (
    <WorkspaceLayoutClient title="Risk Register" subtitle="AI risk register — hallucination, bias, privacy, security, and operational risks">
      <ModuleScaffold title="Risk Register" description="Track, mitigate, and review AI risks across all registered systems." moduleId="governance" icon="landmark" status="done">
        <GovernanceShell>
          {risks.map((r) => (
