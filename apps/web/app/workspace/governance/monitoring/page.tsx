...
export default function MonitoringPage() {
  ...
  return (
    <WorkspaceLayoutClient title="Monitoring" subtitle="Alerts, incidents, drift detection, and anomaly tracking">
      <ModuleScaffold title="Continuous Monitoring" description="Hallucinations, confidence, policy violations, provider changes, and drift alerts." moduleId="governance" icon="landmark" status="done">
        <GovernanceShell>
