...
export default function ReportsPage() {
  ...
  return (
    <WorkspaceLayoutClient title="Reports" subtitle="Inventory, risk, compliance, executive summaries, and audit evidence">
      <ModuleScaffold title="Governance Reports" description="Export inventory, risk, policy, compliance, certification, drift, and audit reports." moduleId="governance" icon="landmark" status="done">
        <GovernanceShell>
