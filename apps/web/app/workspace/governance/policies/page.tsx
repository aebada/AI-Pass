...
export default function PoliciesPage() {
  ...
  return (
    <WorkspaceLayoutClient title="Policy Management" subtitle="Create, version, publish, and retire AI governance policies">
      <ModuleScaffold title="Policy Management" description="AI usage, security, data, approval, prompt, and model selection policies." moduleId="governance" icon="🏛" status="done">
        <GovernanceShell>
          {policies.map((p) => (
