...
import { CONTACT_EMAIL, mailtoContact } from '../lib/site-config';
    ...
    <div className={styles.page}>
        ...
        <div className={styles.pillarGrid}>
          {PILLARS.map((pillar) => (
            <div key={pillar.title} className={styles.pillarCard}>
              <div className={styles.pillarIcon}><ModuleIcon name={pillar.icon} size={22} /></div>
      ...
      <section className={`${styles.section} ${styles.sectionAlt}`} id="contact">
        ...
        <div className={styles.contactBox}>
          ...
          <a href={mailtoContact()} className={styles.contactEmail}>
            {CONTACT_EMAIL}
          </a>
        </div>
      </section>
