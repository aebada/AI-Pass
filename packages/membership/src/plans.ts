...
export const POWER_ONLY_MODEL_IDS = [
  'gpt-5',
  'gpt-5.6-sol',
  'claude-opus-4',
  'claude-opus-5',
...
const ENTERPRISE_FEATURES: MembershipFeature[] = [
  ...
  'digital_twin_integrations',
  'digital_twin_enterprise',
];
...
export const MEMBERSHIP_PLANS: MembershipPlan[] = [
  {
    ...
    highlights: [
      ...
      'Digital Twin — 50 messages/mo, text only',
      'Browse Marketplace',
    ],
  },
  {
    ...
    highlights: [
      ...
      'Digital Twin Starter — 500 msgs, speech, 1 calendar',
  ...
  },
  {
    ...
    highlights: [
      ...
      'Digital Twin Pro — unlimited msgs, multi-calendar, memory',
  ...
  },
  {
    ...
    highlights: [
      ...
      'Digital Twin Enterprise — WhatsApp, medical vault, team twins',
