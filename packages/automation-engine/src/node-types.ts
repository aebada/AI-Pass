...
> = {
  trigger: { label: 'Trigger', icon: 'zap', description: 'Workflow entry point', color: '#6366f1' },
  ...
  approval: { label: 'Approval', icon: 'check', description: 'Human approval gate', color: '#10b981' },
  notification: { label: 'Notify', icon: 'mail', description: 'Send notification', color: '#3b82f6' },
  marketplace_app: { label: 'Marketplace App', icon: 'store', description: 'Run installed app', color: '#ec4899' },
  agent: { label: 'Agent', icon: 'bot', description: 'Run AI agent', color: '#6366f1' },
  external_api: { label: 'External API', icon: 'link', description: 'HTTP request', color: '#14b8a6' },
  skill: { label: 'Skill', icon: 'settings', description: 'Invoke marketplace skill', color: '#a855f7' },
};
