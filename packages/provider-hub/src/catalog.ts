...
export const MODEL_CATALOG: ModelCatalogEntry[] = [
  ...
  model('gpt-5.6-luna', 'openai', 'OpenAI', 'gpt-5.6-luna', 'GPT-5.6 Luna', 'Efficient high-volume GPT-5.6', 'fast', 'great', 'standard', 256000, 1, 4, ['High volume', 'Classification'], ['gpt-5.6']),
  model('gpt-5.6-terra', 'openai', 'OpenAI', 'gpt-5.6-terra', 'GPT-5.6 Terra', 'Balanced intelligence and cost', 'balanced', 'frontier', 'premium', 256000, 5, 20, ['Agents', 'Coding'], ['gpt-5.6']),
  model('gpt-5.6-sol', 'openai', 'OpenAI', 'gpt-5.6-sol', 'GPT-5.6 Sol', 'Frontier GPT-5.6 for complex work', 'quality', 'frontier', 'frontier', 256000, 15, 60, ['Complex reasoning', 'Agent workflows'], ['flagship', 'gpt-5.6']),
  model('gpt-5', 'openai', 'OpenAI', 'gpt-5.6-sol', 'GPT-5.6', 'Alias for GPT-5.6 Sol', 'balanced', 'frontier', 'frontier', 256000, 15, 60, ['Complex reasoning', 'Code generation'], ['flagship']),
  ...
  model('claude-haiku', 'anthropic', 'Claude', 'claude-haiku-4-5-20251001', 'Claude Haiku 4.5', 'Fast Claude responses', 'fast', 'great', 'standard', 200000, 0.8, 4, ['Support', 'Triage', 'Summaries'], ['fast']),
  model('claude-sonnet-4', 'anthropic', 'Claude', 'claude-sonnet-4-20250514', 'Claude Sonnet 4', 'Balanced Claude 4', 'balanced', 'frontier', 'premium', 200000, 3, 15, ['Coding', 'Analysis', 'Writing'], []),
  model('claude-sonnet-5', 'anthropic', 'Claude', 'claude-sonnet-5', 'Claude Sonnet 5', 'Latest Sonnet mid-tier', 'balanced', 'frontier', 'premium', 200000, 3, 15, ['Coding', 'Agents'], ['flagship']),
  model('claude-opus-4', 'anthropic', 'Claude', 'claude-opus-4-20250514', 'Claude Opus 4', 'Claude 4 maximum capability', 'quality', 'frontier', 'frontier', 200000, 15, 75, ['Research', 'Complex agents'], ['frontier']),
  model('claude-opus-5', 'anthropic', 'Claude', 'claude-opus-5', 'Claude Opus 5', 'Latest Opus frontier', 'quality', 'frontier', 'frontier', 200000, 15, 75, ['Research', 'Deep agents'], ['flagship', 'frontier']),

  model('gemini-flash', 'gemini', 'Gemini', 'gemini-2.5-flash', 'Gemini 2.5 Flash', 'Ultra-fast Gemini', 'fast', 'great', 'standard', 1000000, 0.15, 0.6, ['Real-time', 'High volume'], ['fast']),
  model('gemini-3.6-flash', 'gemini', 'Gemini', 'gemini-3.6-flash', 'Gemini 3.6 Flash', 'Latest Gemini Flash workhorse', 'fast', 'frontier', 'standard', 1000000, 0.2, 0.8, ['Real-time', 'Multimodal'], ['fast', 'flagship']),
  model('gemini-pro', 'gemini', 'Gemini', 'gemini-2.5-pro', 'Gemini 2.5 Pro', 'Google multimodal Pro', 'balanced', 'frontier', 'premium', 1000000, 2.5, 10, ['Long context', 'Multimodal'], ['multimodal']),
  model('gemini-3.1-pro', 'gemini', 'Gemini', 'gemini-3.1-pro-preview', 'Gemini 3.1 Pro', 'Latest Gemini Pro preview', 'balanced', 'frontier', 'frontier', 1000000, 3, 12, ['Long context', 'Research'], ['flagship']),

  model('kimi-k2.6', 'kimi', 'Kimi', 'kimi-k2.6', 'Kimi K2.6', 'General-purpose Kimi with vision and tools', 'balanced', 'great', 'standard', 256000, 0.95, 4, ['Chat', 'Tools', 'Vision'], ['kimi']),
  model('kimi-k2.7-code', 'kimi', 'Kimi', 'kimi-k2.7-code', 'Kimi K2.7 Code', 'Kimi coding agent model', 'balanced', 'frontier', 'premium', 256000, 0.95, 4, ['Coding agents', 'Repos'], ['kimi', 'coding']),
  model('kimi-k3', 'kimi', 'Kimi', 'kimi-k3', 'Kimi K3', 'Moonshot flagship — 1M context, deep reasoning', 'quality', 'frontier', 'frontier', 1000000, 3, 15, ['Long-horizon coding', 'Agents', 'Reasoning'], ['kimi', 'flagship']),

  model('deepseek-v3', 'openrouter', 'OpenRouter', 'deepseek/deepseek-chat-v3-0324', 'DeepSeek V3', 'Strong coding and math', 'balanced', 'great', 'premium', 64000, 0.27, 1.1, ['Code', 'Math', 'Cost-efficient'], ['coding']),
  ...
  model('deepseek-free', 'openrouter', 'OpenRouter', 'deepseek/deepseek-chat', 'DeepSeek Free', 'Low-cost DeepSeek via OpenRouter', 'fast', 'good', 'free', 64000, 0, 0, ['Free chat', 'Experiments'], ['free']),
  ...
  model('llama-3.3-70b', 'llama', 'Llama', 'meta-llama/llama-3.3-70b-instruct:free', 'Llama 3.3 70B', 'Proven open model', 'balanced', 'good', 'free', 128000, 0.2, 0.2, ['General chat', 'RAG'], ['open']),
  ...
  model('grok-4.3', 'grok', 'Grok', 'grok-4.3', 'Grok 4.3', 'Long-context Grok workhorse', 'balanced', 'frontier', 'premium', 1000000, 3, 12, ['Long context', 'Tools'], ['grok']),
  model('grok-4.5', 'grok', 'Grok', 'grok-4.5', 'Grok 4.5', 'Latest Grok coding and agents flagship', 'balanced', 'frontier', 'frontier', 500000, 5, 20, ['Coding', 'Agents'], ['flagship', 'grok']),
  ...
  model('cerebras-llama', 'cerebras', 'Cerebras', 'gemma-4-31b', 'Cerebras Gemma 4 31B', 'Ultra-fast Cerebras inference', 'fast', 'good', 'standard', 8192, 0.1, 0.1, ['Low latency', 'High volume'], ['cerebras']),
  model('cerebras-70b', 'cerebras', 'Cerebras', 'gpt-oss-120b', 'Cerebras GPT-OSS 120B', 'Fast 120B on Cerebras', 'fast', 'great', 'premium', 128000, 0.6, 0.6, ['Production chat'], ['cerebras']),

  model('sambanova-llama', 'sambanova', 'SambaNova', 'Meta-Llama-3.3-70B-Instruct', 'SambaNova Llama 3.3 70B', 'Large model on SambaNova Cloud', 'balanced', 'frontier', 'frontier', 128000, 5, 15, ['Enterprise', 'Research'], ['sambanova']),
  model('sambanova-deepseek', 'sambanova', 'SambaNova', 'DeepSeek-V3.2', 'SambaNova DeepSeek V3.2', 'DeepSeek on SambaNova', 'balanced', 'great', 'premium', 64000, 1, 3, ['Code', 'Reasoning'], ['sambanova']),
