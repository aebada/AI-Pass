...
export type FakeInvoiceVerdict = 'Authentic' | 'Suspicious' | 'Likely Fake';

export interface FakeInvoiceDetection {
  /** Document authenticity risk 0–100 (higher = more likely fake). */
  authenticityScore: number;
  signals: string[];
  verdict: FakeInvoiceVerdict;
  /** Raw risk score 0–1. */
  riskScore: number;
}
...
export interface UploadInvoiceResponse {
  ...
  authenticity: FakeInvoiceDetection;
