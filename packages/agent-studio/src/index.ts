...
// Re-export agent-core framework for Studio consumers
export type {
  AgentRegistryEntry as CoreAgentRegistryEntry,
  AgentLifecycle,
  ObservabilityMetrics as CoreObservabilityMetrics,
} from '@ai-pass/agent-core';
export { getAgentRegistry as getCoreAgentRegistry } from '@ai-pass/agent-core';
