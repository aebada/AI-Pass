...
| — | Knowledge Graph | `/workspace/knowledge-graph` | stub |
| — | Semantic Layer | `/workspace/semantic` | stub |
| — | Data Products | `/workspace/data-products` | stub |
...
| `@ai-pass/knowledge-graph` | Entity-relationship graph, neighbors, type queries |
| `@ai-pass/semantic-layer` | Metrics, entities, dimensions, semantic catalog store |
| `@ai-pass/data-products` | Data product catalog, ownership, quality, contracts |
